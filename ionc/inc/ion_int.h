...
ION_API_EXPORT iERR ion_int_from_decimal_big(ION_INT *iint, const decNumber *p_value);
...
ION_API_EXPORT iERR ion_int_to_decimal_big  (ION_INT *iint, decNumber *p_value);
